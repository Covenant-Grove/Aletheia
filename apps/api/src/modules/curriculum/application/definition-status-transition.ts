...
// Shared status-transition state machine for every Definition/Version table
// (issue #96 Fase 0). DRAFT/PUBLISHED/DEPRECATED/ARCHIVED transitions are
// always an explicit call through this function -- never an implicit side
// effect of a generic "update" -- and each transition is one-way:
// ARCHIVED is terminal, and nothing skips backwards.
